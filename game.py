...
tk.Button(button_frame, text="✂ Scissors", command=lambda: play_round("Scissors"), bg="#FFB6C1", **button_style).grid(row=0, column=2, padx=5)
...
results_display.insert(tk.END, "Rock ~ Paper ~ Scissor by Prashant Kumar\n\n")
